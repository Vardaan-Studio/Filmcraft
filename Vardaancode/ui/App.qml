...
Rectangle {
    ...
    Image {
        source: mainWindow.minimizeIcon
        anchors.centerIn: parent
        width: mainWindow.minimizeIconWidth
        height: mainWindow.minimizeIconHeight
    ...
    Button {
       ...
       //close button
        ...
        Button {
            ...
            Image {
                source: mainWindow.closeIcon
                anchors.centerIn: parent
                width: mainWindow.closeIconWidth
                height: mainWindow.closeIconHeight
                fillMode: Image.PreserveAspectFit
            }
           ...
           contentItem: Rectangle {
               ...
               Column {
                   ...
                   Row {
                       ...
                       // Column for MP4 and other format buttons
                       Column {
                           spacing: 10
